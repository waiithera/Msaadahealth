...
class ChatBot:
    ...
    def mainWindowSetUp(self):
        ...
        self.root.title("Doc McStuffins")
        self.root.geometry("1000x1000")
        self.root.resizable(width=FALSE, height=FALSE)
 
  # Load and place background image
        bg_image = Image.open("doctor3.png")
        bg_image = bg_image.resize((2000, 1000), Image.LANCZOS)
        self.bg_photo = ImageTk.PhotoImage(bg_image)
        self.bg_label = Label(self.root, image=self.bg_photo)
        self.bg_label.place(x=0, y=0, relwidth=1, relheight=1)

        #Here is a textbox where the number of the assistant and their status is presented 
 ...
 # Load and place background image
        ...
        self.label1.place(x=500,y=5, height=35, width=345)
        ...
        self.label2.place(x=500,y=40, height=35, width=345)
        ...
        self.label8.place(x=500,y=65, height=35, width=345)
        ...
        self.label3.place(x=500,y=95, height=25, width=345)
        ...
        self.label4.place(x=500,y=125, height=35, width=90)

        self.label5 = Label(self.root, text="Age:",  width="12", height=5,bd=0,foreground='black',font=("Arial", 10))
        self.label5.place(x=500,y=175, height=35, width=90)

        self.label6 = Label(self.root, text="Gender:",  width="12", height=5,bd=0,foreground='black',font=("Arial", 10))
        self.label6.place(x=500,y=225, height=35, width=90)

        self.label7 = Label(self.root, text="Phone number:",  width="12", height=5,bd=0,foreground='black',font=("Arial", 10))
        self.label7.place(x=500,y=275, height=35, width=90)
        
        #Here is where the textboxes the user writes in are created
        self.chatWindow1 = Text(self.root, bd=1, bg="white",  width="50", height="8", font=("Arial", 10), foreground="black", padx=10, pady=10,wrap=WORD)
        self.chatWindow1.place(x=620,y=125, height=35, width=250)

        self.chatWindow2 = Text(self.root, bd=1, bg="white",  width="50", height="8", font=("Arial", 10), foreground="black", padx=10, pady=10,wrap=WORD)
        self.chatWindow2.place(x=620,y=175, height=35, width=250)

        self.chatWindow3 = Text(self.root, bd=1, bg="white",  width="50", height="8", font=("Arial", 10), foreground="black", padx=10, pady=10,wrap=WORD)
        self.chatWindow3.place(x=620,y=225, height=35, width=250)

        self.chatWindow4 = Text(self.root, bd=1, bg="white",  width="50", height="8", font=("Arial", 10), foreground="black", padx=10, pady=10,wrap=WORD)
        self.chatWindow4.place(x=620,y=275, height=35, width=250)
        ...
        self.button1.place(x=620,y=325, height=35, width=250)
